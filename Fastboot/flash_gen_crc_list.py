...
unsparse_file_list = {
    ...
    "hyp_ac_config":"hyp_ac_config.mbn",
    ...
    "misc":"misc.img",
    "modem":"NON-HLOS.bin",
    "modemfirmware":"MODEM-FW.bin",
    "multiimgoem":"multi_image.mbn",
    "multiimgqti":"multi_image_qti.mbn",
    "pdp":"pdp.elf",
    "pdp_cdb":"pdp_cdb.elf",
    "pvmfw":"pvmfw.img",
    "qtvm_dtbo":"qtvm-dtbo.img",
    "qupfw":"qupv3fw.elf",
    "recovery":"recovery.img",
    "secretkeeper":"secretkeeper.mbn",
    "shrm":"shrm.elf",
    "soccp":"soccp.bin",
    "soccp_dcd":"dcd.mbn",
    "soccp_debug":"sdi.mbn",
    ...
    "storsec":"storsec.mbn",
    "tme_config":"tme_config.elf",
    "tme_fw":"signed_firmware_soc_view.elf",
    "tme_seq_patch":"sequencer_ram.elf",
    "toolsfv":"tools.fv",
    "tz":"tz.mbn",
    "tz_ac_config":"tz_ac_config.mbn",
    "tz_qti_config":"tz_qti_config.mbn",
    "uefi":"uefi.elf",
    ...
    "xbl":"xbl_sc.elf",
    "xbl_ac_config":"xbl_ac_config.mbn",
    ...
    try:
        ...
        for ptn in file_list:
          ...
          if not os.path.isfile(filepath):
            ...
            continue
          if ptn in unsparse_file_list.keys():
